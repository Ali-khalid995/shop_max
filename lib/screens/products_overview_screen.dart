...
import 'package:shop_max/widgets/badge.dart';
import 'package:shop_max/widgets/products_grid.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          PopupMenuButton(
            ...
            itemBuilder: (_) => [
              PopupMenuItem(
                child: Text(getTranslated(context, 'only_favorites')),
                value: FilterOptions.Favorites,
              ),
              PopupMenuItem(
                child: Text(getTranslated(context, 'show_all')),
